...
1. Pour chaque fonction non implémentée dans le fichier exercice_3.py, l'implémenter de manière à respecter
...
2. Augmenter la taille du paramètre d'entrée n (5x, 20x, 50x, etc.) dans le main et relancer le programme
...
if __name__ == "__main__":
    ...
    #test_func = ['comp_constant', 'comp_lineaire', 'comp_quadratique', 'comp_x']
